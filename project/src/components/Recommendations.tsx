...
import { Car, Utensils, Zap, Trash2, Lightbulb, ArrowRight } from 'lucide-react';
...
const Recommendations: React.FC = () => {
  ...
  const priorityActions = [
    ...
    },
    {
      ...
      description: 'Try Meatless Mondays or replace one meat meal per day with a plant-based alternative.',
    },
    {
      ...
      description: 'Replace car trips with public transport, walking, or cycling for short distances.',
    },
  ];
